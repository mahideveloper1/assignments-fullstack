...
// Sample initial knowledge graph relations
export const initialSkillRelations = [
  {
    source: 'React',
    targets: ['React.js', 'ReactJS', 'React Native'],
    strength: 0.9
  },
  {
    source: 'JavaScript',
    targets: ['TypeScript', 'Node.js', 'React', 'Angular', 'Vue'],
    strength: 0.7
  },
  {
    source: 'Node.js',
    targets: ['Express', 'Koa', 'Nest.js'],
    strength: 0.8
  },
  {
    source: 'AWS',
    targets: ['AWS Lambda', 'EC2', 'S3', 'DynamoDB'],
    strength: 0.8
  },
  {
    source: 'GraphQL',
    targets: ['Apollo', 'REST API'],
    strength: 0.6
  }
];